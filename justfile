...
test-wrapper:
    #!/usr/bin/env bash
    cd calc-wrapper
    ./build/bin/Debug/calc-wrapper.exe add 1 2
    ./build/bin/Debug/calc-wrapper.exe substract 5 3
    ./build/bin/Debug/calc-wrapper.exe multiply 4 6
    ./build/bin/Debug/calc-wrapper.exe divide 8 2
    ./build/bin/Debug/calc-wrapper.exe square 8
